...
export class VehicleModel {
	...
	public async register(fleetId: string) {
		...
		await this.repository.saveVehicle(this.toEntity());
	}
	...
	public async park(
		...
		const newPosition = new PositionModel(longitude, latitude, altitude);
	 ...
	 * @returns {VehicleEntity} 
	 */
	private toEntity(): VehicleEntity {
